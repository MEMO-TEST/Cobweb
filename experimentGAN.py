...
from Cobweb.Cobweb_tabular import BoundaryFair
...
from utils.diversity_test import pca_plot
...
if __name__ == '__main__':
    ...
    # dataset_names = ['census', 'credit']
    select_strategy = 'BT' #'kmeans'
    approach_name = 'BF_GA_GAN_KM' if select_strategy == "kmeans" else "BF_GA_GAN_BT"
    # approach_name = "random"
    # approach_name = 'BF_GA_GAN_LR'
    ...
    flag_retrain = False
    flag_fm = False
    flag_distance_measure = False
    
    
    # random_or_cluster = 0 #0 for random, 1 for cluster
    for random_or_cluster in range(1):
        ...
        for dataset_name in dataset_names:
            ...
            # for sens_param_index in [8]:
                ...
                # model_path = f'model_info/unawareness/{dataset_name}_{sens_param_index}_fakemodel.pkl'
                ...
                BF = BoundaryFair(data_config=data_config[dataset_name], sens_param_index = sens_param_index, input_type=input_type,
                ...
                if (not os.path.exists(result_path)) or flag_retest: 
                    ...
                    if not input_type == 'numpy':
                        disc_samples = [disc_sample.cpu().numpy() for disc_sample in disc_samples]
